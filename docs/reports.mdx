...
```json
{
  ...
  "botUsername": null,
  "instances": [
    { "botUsername": "pw_a1", "passed": true, "durationMs": 640, "error": null },
    { "botUsername": "pw_b2", "passed": false, "durationMs": 812, "error": "Expected message matching \"Claimed\" not received" },
    { "botUsername": "pw_c3", "passed": true, "durationMs": 701, "error": null }
  ]
}
```
